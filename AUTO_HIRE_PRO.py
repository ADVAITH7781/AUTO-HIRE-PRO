...
def main():
    ...
    st.markdown("""
        ...
        .stApp { 
            background-image: linear-gradient(to bottom, #FFFFFF 550px, rgba(255,255,255,0.92) 550px), url('https://images.unsplash.com/photo-1497366811353-6870744d04b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80');
